...
/*
    ...
    PROJEYE DATABASE EKLENDİTEN SONRA KULLANIM DIŞI KALMIŞTIR GEÇMİŞE DAİR GÖZÜKMESİ AÇISINDAN PROJE DOSYALARI ARASINDA DURMAKTADIR.
 */
namespace OOP_LAB
{
    public class Util
    {
        ...
        //            userlist.Add(new User(username, password, namesurname, phonenumber, address,city,country,email,0,"normal"));
